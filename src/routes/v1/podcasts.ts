...
app.get("/live", async (c) => {
	...
	const liveFromPodcastApi = await podcastApi("/episodes/byfeedid", query).then((res) => res.json())
		.then((res) => res.liveItems);

	const liveData: LiveItems[] = [];
